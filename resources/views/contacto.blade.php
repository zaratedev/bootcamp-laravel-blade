            ...
            <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">Proin volutpat consequat porttitor cras nullam
                        gravida
                        at. Orci molestie a eu arcu. Sed ut tincidunt integer elementum id sem. Arcu sed malesuada et
                        magna.
                    </p>
                ...
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-2.5">
                                <x-inputs.text type="text" autocomplete="given-name" name="first-name" />
                            </div>
                        </div>
                        <div>
                            <x-label for="last-name">
                                Last name
                            </x-label>
                            <div class="mt-2.5">
                                <x-inputs.text type="text" autocomplete="family-name" name="last-name" />
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2.5">
                                <x-inputs.text type="email" autocomplete="email" name="email" />
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            <x-label for="phone-number">
                                Phone number
                            </x-label>
                            <div class="mt-2.5">
                                <x-inputs.text type="tel" autocomplete="tel" name="phone-number" />
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            <x-label for="message">
                            ...
                            <div class="mt-2.5">
                                <x-inputs.text-area name="message" rows="4"></x-inputs.text-area>
                            </div>
                        </div>
                    </div>
